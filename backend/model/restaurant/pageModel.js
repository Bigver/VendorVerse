...
const PageResturantEdit = sequelize.define('page_resturant_edits', {
  id: {
...
StoreOwner.hasOne(PageResturantEdit, { foreignKey: 'store_id' });  // ร้านค้าหนึ่งมีหนึ่งเพจ
PageResturantEdit.belongsTo(StoreOwner, { foreignKey: 'store_id' , as: 'storeOwner' }); // หน้าเพจเชื่อมกับร้านค้า

export default PageResturantEdit;